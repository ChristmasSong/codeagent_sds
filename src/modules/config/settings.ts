...
export function getSettings(): Setting[] {
  return [
    ...
    {
      name: 'code_storage_platform_capacity_gb',
      title: 'Platform R2 capacity alert threshold (GB)',
      type: 'number',
      placeholder: '1000',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'code_storage_monthly_budget_usd',
      title: 'Monthly R2 budget (USD)',
      type: 'number',
      placeholder: '100',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'code_storage_retention_days',
      title: 'Storage snapshot retention days',
      type: 'number',
      placeholder: '7',
      group: 'usage_billing',
      tab: 'general',
    ...
    {
      name: 'code_storage_max_snapshots_per_session',
      title: 'Maximum snapshots per session',
      type: 'number',
      placeholder: '2',
      group: 'usage_billing',
      tab: 'general',
